...
def next_patch_version(version: str) -> str:
    if "-patch." in version:
        base, patch = version.rsplit("-patch.", 1)
        return f"{base}-patch.{int(patch) + 1}"
...
class MarkerTests(unittest.TestCase):
    ...
    def test_operational_policies_are_compact_and_knowledge_aware(self) -> None:
        ...
        self.assertIn("final report at most 120 words", " ".join(investigator.split()))
