...
python3 scripts/package_release.py --verify dist/codex_workflow-1.2.1.zip --version 1.2.1
```
...
py -3.11 scripts/package_release.py --verify dist\codex_workflow-1.2.1.zip --version 1.2.1
```
